...
const PLANS: { tier: Tier; name: string; returns: string; duration: string; min: string; max: string; requiredReferrals: number }[] = [
  ...
  { tier: 'gold',    name: 'Gold',    returns: '30%', duration: '24 Hours', min: '₹3,000', max: '₹50,000',   requiredReferrals: 11 },
  { tier: 'diamond', name: 'Diamond', returns: '40%', duration: '24 Hours', min: '₹5,000', max: '₹1,00,000', requiredReferrals: 21 },
]
