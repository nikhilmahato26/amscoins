 ...
 * Each bonus is dismissed independently by its transaction ID — the user
 * only sees each one once.
 */
export function ReferralBonusNotice({ className }: { className?: string }) {
  ...
  // Collect all unseen referral_bonus credits from the last 30 days
  ...
  // Sum all unseen bonuses into a single banner
