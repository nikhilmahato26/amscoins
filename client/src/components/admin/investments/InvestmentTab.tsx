    ...
    <>
        ...
        <ConfirmDialog
          ...
          body={
            <>
              ...
              <strong className="font-semibold text-asm-navy">{approvingInv.user.name}</strong>. The 72-hour term will start
      ...
      {bulkApproving && (
        <ConfirmDialog
          ...
          body={`Activate ${bulkTargetIds.length} pending investment(s) immediately. Each 72-hour term starts now. This cannot be undone.`}
