...
const TIER_THRESHOLDS = { silver: 0, gold: 5, diamond: 20 } as const

const TIER_STEPS: { tier: Tier; label: string; members: string; tone: string }[] = [
  { tier: 'silver',  label: 'Silver',  members: `0–${TIER_THRESHOLDS.gold - 1} members`,                         tone: 'text-asm-muted'   },
  { tier: 'gold',    label: 'Gold',    members: `${TIER_THRESHOLDS.gold}–${TIER_THRESHOLDS.diamond - 1} members`, tone: 'text-amber-600'   },
  { tier: 'diamond', label: 'Diamond', members: `${TIER_THRESHOLDS.diamond}+ members`,                            tone: 'text-asm-blue'    },
]
...
const UNLOCK_LEVELS: {
  ...
  {
    tier: 'gold',    name: 'Gold',
    requirement: `Unlock with ${TIER_THRESHOLDS.gold} referrals`,
  ...
  },
  {
    ...
    requirement: `Unlock with ${TIER_THRESHOLDS.diamond} referrals`,
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex h-11 items-center justify-between gap-3 rounded-xl border border-asm-line bg-asm-tint px-4">
              <span className="truncate text-[11px] text-asm-muted">{REFERRAL.link}</span>
          ...
          <div className="flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3.5">
            ...
            <span className="flex flex-col gap-0.5">
              ...
              <span className="text-[12px] leading-snug text-amber-900">
                Higher investment limits &amp; exclusive commissions unlock at {REFERRAL.nextTier}.
              </span>
            </span>
          </div>
        </motion.section>
